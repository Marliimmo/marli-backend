...
mongoose.connect(`mongodb+srv://${process.env.BDD_USER}:${process.env.BDD_PASSWORD}@${process.env.BDD_URL}/`,
...
const corsOptions = {
  origin: ['https://choosews.com', 'https://choosews.com/marli', 'https://marli-immobilier.com', 'https://choosews.com/dashboard'] 
};
